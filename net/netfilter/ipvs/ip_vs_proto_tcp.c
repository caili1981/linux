...
struct ip_vs_protocol ip_vs_protocol_tcp = {
	...
	.conn_schedule =	tcp_conn_schedule,   /* 调度算法, 并创建新的session */
	.conn_in_get =		ip_vs_conn_in_get_proto, /* 查询现有连接 */
	.conn_out_get =		ip_vs_conn_out_get_proto, /* 反向查询现有连接 */
	.snat_handler =		tcp_snat_handler,   /* response报文需要做snat */
	.dnat_handler =		tcp_dnat_handler,   /* request报文需要做dnat */
